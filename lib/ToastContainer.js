...
import Smileicon from 'react-native-root-toast/lib/Smileicon';
...
class ToastContainer extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            positionTop: new Animated.Value(-400),
                    ...
                    <Animated.View
                        style={[
                            ...
                            },
                            {
                                ...
                                transform: [{ translateY: this.state.positionTop }],
                            },
                        ]}
                        pointerEvents="none"
                        ref={(ele) => (this._root = ele)}
                    >
                        <ImageBackground source={require('../notification_bg.png')} style={styles.imageBgr}>
                            <Text
                                style={[
                                    styles.textStyle,
                                    props.textStyle,
